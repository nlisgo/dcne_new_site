...
Here is an example of how to enable the Rules module by using the update hook in the new_site_controller.install file:

/**
 * Enabling Rules module
 */
function new_site_controller_update_7000()
{
  $modules = array('rules');
